  ...
  return (
    <>
      ...
      <div style={{width: '48%', float: 'left'}}>
        <img src="public/media/aboutus/1.JPG" style={{minWidth: '150px', width: '50%', padding: '5px'}}/>
        <img src="public/media/aboutus/2.JPG" style={{minWidth: '150px', width: '50%', padding: '5px'}}/>
        <img src="public/media/aboutus/3.JPG" style={{minWidth: '150px', width: '50%', padding: '5px'}}/>
        <img src="public/media/aboutus/4.JPG" style={{minWidth: '150px', width: '50%', padding: '5px'}}/>
      </div>
      </div>
      <Footer />
    </>
