    ...
    <>
      ...
      <div style={{ maxWidth: '1228px', borderRadius: '0.5rem', boxShadow: '0 2px 15px -3px rgba(0, 0, 0, 0.07), 0 10px 20px -2px rgba(0, 0, 0, 0.04)', padding: '30px' }}>
        <div style={{ width: '100%', textAlign: 'left', overflow: 'hidden' }}>         
          <img src="/media/aboutus/2.JPG" style={{ minWidth: '150px', width: '50%', margin: '5px', float: 'right', borderRadius: '3%' }} />
          <div style={{ textAlign: 'left'}}>
            ...
            Kościelisko jest to duża wieś o charakterze miejscowości wypoczynkowej, składająca się z 21 osiedli (dawnych osad pasterskich, tzw. polan 
            – stąd bierze się dawniej oficjalna, a dziś potoczna nazwa miejscowości: Polany), często nazywana „Sercem Podhala”. Można tam podziwiać piękne zabudowy góralskie oraz zabytki – naprawdę warto zobaczyć to miejsce.
            <br/>
            <br/>
            W okolicy znajdują się wyciągi narciarskie dla początkujących i zaawansowanych narciarzy np. stacja narciarska Szymaszkowa 2 km, Ski Witów 6 km oraz przepiękne bezpłatne profesjonalnie przygotowane trasy biegowe 2,1 km, strzelnica biatlonowa 3 km. Karczmy regionalne i restauracje, Góralski Gościniec 50 m, Karczma Polany 1,5 km i inne.
            <br/>  
